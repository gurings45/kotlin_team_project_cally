...
//RecyclerView 스와이프 기능 추가
class SwipeHelperCallBack(val todoRecyclerAdapter: TodoRecyclerAdapter) : ItemTouchHelper.Callback(){
    ...
    override fun onMove(
        ...
        todoRecyclerAdapter.swapData(fromPos, toPos)
        return true
    }
    ...
    // -------------swipe 됐을 때 일어날 동작---------------
    // swipeView만 슬라이드 되도록 + 일정 범위를 swipe하면 <삭제> 화면 보이게 하기
    ...
    override fun clearView(recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder) {
        ...
        previousPosition = viewHolder.bindingAdapterPosition    // 드래그 또는 스와이프 동작이 끝난 view의 position 기억하기
